      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <!-- Button -->
            ...
            <button type="button" class="navbar-btn btn btn-sm btn-success-soft lift ms-auto" data-bs-target="#bantuanModal" data-bs-toggle="modal">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Silahkan melakukan registrasi dengan menginputkan nama, status dan keperluan serta melakukan pengecekan suhu.</p>
        <br>
